...
public:
    ...
    void retranslateUi(QDialog *ShowInvoice)
    {
        ShowInvoice->setWindowTitle(QCoreApplication::translate("ShowInvoice", "Dialog", nullptr));
